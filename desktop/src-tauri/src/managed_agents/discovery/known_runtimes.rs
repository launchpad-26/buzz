//! The compiled-in ACP runtime table and its avatar constants, split out of
//! `discovery.rs` to respect the repo's file-size ratchet.
...
pub(crate) const KNOWN_ACP_RUNTIMES: &[KnownAcpRuntime] = &[
    ...
    KnownAcpRuntime {
        ...
        thinking_config_json_env_var: Some("CODEX_CONFIG"),
        thinking_config_json_key: Some("model_reasoning_effort"),
        max_tokens_env_var: None,
        context_limit_env_var: None,
        max_rounds_env_var: None,
        required_normalized_fields: &[],
