...
mod tests {
    ...
    use super::runtime_fixtures::{make_cli_runtime, make_codex_runtime};
...
// `KnownAcpRuntime` fixtures for the tests above live in a sibling file so this
// module stays under the desktop file-size ratchet.
#[cfg(test)]
#[path = "readiness_test_runtimes.rs"]
