//! Avatar-materialization tests for `personas/snapshot/import.rs`, split into a
//! sibling file to respect the repo's file-size ratchet.
//!
//! Declared as `mod import_avatar_tests` from `import.rs`.
