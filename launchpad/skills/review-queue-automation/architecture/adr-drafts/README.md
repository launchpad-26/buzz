...
| [ADR-F](ADR-F.md) | [#2159](https://github.com/launchpad-26/buzz/issues/2159) | Record integrity | not blocking | **historical:** ADR-0063's operator-key HMAC was superseded by keyless chained, externally anchored [ADR-0066](../../../../decisions/ADR-0066-rqa-record-chain-anchoring-without-a-key.md) |
