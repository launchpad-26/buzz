...
| [ADR-H](ADR-H.md) | [#2217](https://github.com/launchpad-26/buzz/issues/2217) | How a non-built-in harness is admitted to run | **blocking** | operator-declared `command` gated by the conformance pair — implemented in PR #2176 pending decision |
