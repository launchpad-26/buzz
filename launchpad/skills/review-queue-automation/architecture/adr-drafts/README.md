...
Five decisions the architecture could not make alone. All five were filed as ADR sub-issues of #2006
and **all five were decided on 2026-09-11, each to the recommendation below**, and recorded as
`launchpad/decisions/ADR-0061`–`ADR-0065`. These drafts are retained as the architecture's rationale;
...
| [ADR-F](ADR-F.md) | [#2159](https://github.com/launchpad-26/buzz/issues/2159) | Record integrity | not blocking | hash chain plus operator-key HMAC — accepted as [ADR-0063](../../../../decisions/ADR-0063-rqa-record-provenance-integrity.md), superseded by keyless anchored-chain [ADR-0066](../../../../decisions/ADR-0066-rqa-record-chain-anchoring-without-a-key.md) |
