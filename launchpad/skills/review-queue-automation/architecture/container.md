...
| `record_anchors` | SQLite local anchor rows | P-12 | P-12 | ADR-0066 anchor delivery | a local anchor is minted before publication; failed publications remain pending |
| `record_anchor_evidence` | authenticated external anchor provenance and immutable locator | P-12 | P-12 | ADR-0066 recovery | recovered evidence never carries a record payload or appends a record entry |
