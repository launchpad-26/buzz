...
| T14 | predecessor has a chain or anchor break, a legacy row segment, or no rows | every obligation regenerates as `untrusted_predecessor`; no judgement/pin row is read. Historical keyed/HMAC columns alone are not a break under ADR-0066. |
