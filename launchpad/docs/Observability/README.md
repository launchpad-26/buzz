...
- [Coverage inventory](current-state/coverage.md) — the canonical stage-1 component completeness record ([issue #462](https://github.com/launchpad-26/buzz/issues/462))
...
assessment owner. The runtime pages contain the current evidence while keeping decisions
and future implementation out of these documents.
